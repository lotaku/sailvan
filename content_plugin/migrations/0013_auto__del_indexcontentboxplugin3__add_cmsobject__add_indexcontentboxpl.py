...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'IndexContentBoxPlugin3'
        db.delete_table(u'content_plugin_indexcontentboxplugin3')

        # Adding model 'CMSObject'
        db.create_table(u'content_plugin_cmsobject', (
        ...
        db.send_create_signal(u'content_plugin', ['CMSObject'])

        # Adding model 'IndexContentBoxPlugin3'
        db.create_table(u'content_plugin_indexcontentboxplugin3', (
            (u'cmsobject_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['content_plugin.CMSObject'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'content_plugin', ['IndexContentBoxPlugin3'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'CMSObject'
        db.delete_table(u'content_plugin_cmsobject')
