...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'IndexContentBoxPlugin2'
        db.create_table(u'content_plugin_indexcontentboxplugin2', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('index_content_box', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['content.IndexContentBox'])),
        ))
        db.send_create_signal(u'content_plugin', ['IndexContentBoxPlugin2'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'IndexContentBoxPlugin2'
        db.delete_table(u'content_plugin_indexcontentboxplugin2')
    ...
    models = {
        ...
        u'content_plugin.indexcontentboxplugin2': {
            'Meta': {'object_name': 'IndexContentBoxPlugin2', '_ormbases': ['cms.CMSPlugin']},
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'index_content_box': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['content.IndexContentBox']"})
        },
