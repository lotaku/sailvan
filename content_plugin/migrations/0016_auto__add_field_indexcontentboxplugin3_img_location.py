...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IndexContentBoxPlugin3.img_location'
        db.add_column(u'content_plugin_indexcontentboxplugin3', 'img_location',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=256),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IndexContentBoxPlugin3.img_location'
        db.delete_column(u'content_plugin_indexcontentboxplugin3', 'img_location')
