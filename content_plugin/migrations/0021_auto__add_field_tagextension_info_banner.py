...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TagExtension.info_banner'
        db.add_column(u'content_plugin_tagextension', 'info_banner',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TagExtension.info_banner'
        db.delete_column(u'content_plugin_tagextension', 'info_banner')
