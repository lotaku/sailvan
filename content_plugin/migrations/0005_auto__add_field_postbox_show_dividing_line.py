...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PostBox.show_dividing_line'
        db.add_column(u'content_plugin_postbox', 'show_dividing_line',
                      self.gf('django.db.models.fields.NullBooleanField')(default=1, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PostBox.show_dividing_line'
        db.delete_column(u'content_plugin_postbox', 'show_dividing_line')
    ...
    models = {
        ...
        u'content_plugin.postbox': {
            ...
            'show_dividing_line': ('django.db.models.fields.NullBooleanField', [], {'default': '1', 'null': 'True', 'blank': 'True'}),
            'template': ('django.db.models.fields.CharField', [], {'default': '1', 'max_length': '256'})
        },
