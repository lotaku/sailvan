...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TagExtension.brief'
        db.add_column(u'content_plugin_tagextension', 'brief',
                      self.gf('ckeditor.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TagExtension.brief'
        db.delete_column(u'content_plugin_tagextension', 'brief')
