...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IndexContentBoxPlugin3.my_placeholder'
        db.add_column(u'content_plugin_indexcontentboxplugin3', 'my_placeholder',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Placeholder'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IndexContentBoxPlugin3.my_placeholder'
        db.delete_column(u'content_plugin_indexcontentboxplugin3', 'my_placeholder_id')
