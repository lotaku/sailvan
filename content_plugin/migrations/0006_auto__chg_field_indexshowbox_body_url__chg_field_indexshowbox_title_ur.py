...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IndexShowBox.body_url'
        db.alter_column(u'content_plugin_indexshowbox', 'body_url', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'IndexShowBox.title_url'
        db.alter_column(u'content_plugin_indexshowbox', 'title_url', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

    def backwards(self, orm):

        # Changing field 'IndexShowBox.body_url'
        db.alter_column(u'content_plugin_indexshowbox', 'body_url', self.gf('django.db.models.fields.URLField')(max_length=256, null=True))

        # Changing field 'IndexShowBox.title_url'
        db.alter_column(u'content_plugin_indexshowbox', 'title_url', self.gf('django.db.models.fields.URLField')(max_length=256, null=True))
    ...
    models = {
        ...
        u'content_plugin.indexshowbox': {
            ...
            'body_url': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            u'cobject_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['core.CObject']", 'unique': 'True', 'primary_key': 'True'}),
            ...
            'title_url': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'})
        },
        ...
        u'content_plugin.postbox': {
            ...
            u'cobject_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['core.CObject']", 'unique': 'True', 'primary_key': 'True'}),
            'reverse_id': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'show_dividing_line': ('django.db.models.fields.NullBooleanField', [], {'default': '2', 'null': 'True', 'blank': 'True'}),
            'template': ('django.db.models.fields.CharField', [], {'default': '1', 'max_length': '256'})
        },
