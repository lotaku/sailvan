...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TagExtension'
        db.create_table(u'content_plugin_tagextension', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('public_extension', self.gf('django.db.models.fields.related.OneToOneField')(related_name='draft_extension', unique=True, null=True, to=orm['content_plugin.TagExtension'])),
            ...
            ('info_banner', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'content_plugin', ['TagExtension'])

        # Adding model 'IndexContentBox'
        db.create_table(u'content_plugin_indexcontentbox', (
            (u'cobject_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.CObject'], unique=True, primary_key=True)),
            ('my_placeholder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Placeholder'], null=True)),
            ...
            ('img_location', self.gf('django.db.models.fields.CharField')(default=1, max_length=256)),
            ('background_color', self.gf('django.db.models.fields.CharField')(default=1, max_length=256)),
        ))
        db.send_create_signal(u'content_plugin', ['IndexContentBox'])

        # Adding model 'PostBox'
        db.create_table(u'content_plugin_postbox', (
            (u'cobject_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.CObject'], unique=True, primary_key=True)),
            ('reverse_id', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('template', self.gf('django.db.models.fields.CharField')(default=1, max_length=256)),
        ))
        db.send_create_signal(u'content_plugin', ['PostBox'])

        # Adding model 'RightBox'
        db.create_table(u'content_plugin_rightbox', (
            (u'cobject_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.CObject'], unique=True, primary_key=True)),
            ('template', self.gf('django.db.models.fields.CharField')(default=1, max_length=256)),
        ))
        db.send_create_signal(u'content_plugin', ['RightBox'])

        # Adding model 'IndexShowBox'
        db.create_table(u'content_plugin_indexshowbox', (
            (u'cobject_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.CObject'], unique=True, primary_key=True)),
            ('template', self.gf('django.db.models.fields.CharField')(default=1, max_length=256)),
        ...
        db.send_create_signal(u'content_plugin', ['IndexShowBox'])

        # Adding model 'Menu_1'
        db.create_table(u'content_plugin_menu_1', (
            (u'cobject_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.CObject'], unique=True, primary_key=True)),
            ('template', self.gf('django.db.models.fields.CharField')(default=1, max_length=256)),
            ('title_url', self.gf('django.db.models.fields.URLField')(max_length=256, null=True, blank=True)),
            ('body_url', self.gf('django.db.models.fields.URLField')(max_length=256, null=True, blank=True)),
        ...
        db.send_create_signal(u'content_plugin', ['Menu_1'])


    def backwards(self, orm):
        # Deleting model 'TagExtension'
        db.delete_table(u'content_plugin_tagextension')

        # Deleting model 'IndexContentBox'
        db.delete_table(u'content_plugin_indexcontentbox')

        # Deleting model 'PostBox'
        db.delete_table(u'content_plugin_postbox')

        # Deleting model 'RightBox'
        db.delete_table(u'content_plugin_rightbox')

        # Deleting model 'IndexShowBox'
        db.delete_table(u'content_plugin_indexshowbox')

        # Deleting model 'Menu_1'
        db.delete_table(u'content_plugin_menu_1')
